...
// START OF GENERAL LAYOUT
	...
	if ( ( $add_on_query_get != "" ) ) {
		...
		if ($general_type == "supplier") {
	
			$sql = "SELECT ".$odbc_code.",".$odbc_desc.",Ageing01,Ageing02,Ageing03,Ageing04,Ageing05,Blocked FROM ".$odbc_table." WHERE ".$add_search." ORDER BY ".$odbc_code ;          
