...
<?
	...
	print( createHeading("Get Customer Code", "close") ) ;	
	...
	if (isset($_GET['q'])) {
		...
		print("<form method=get id=f action=get_customers_name.php>
				<input type=hidden name=field value='".$_GET['field']."'>
				<input type=text name=q id=query autocomplete=off size=30 onKeyUp=displayunicode(event,'ccode')>
